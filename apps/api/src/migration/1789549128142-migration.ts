...
export class Migration1789549128142 implements MigrationInterface {
    name = 'Migration1789549128142'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."content_accesstype_enum" AS ENUM('free', 'premium')`);
        await queryRunner.query(`ALTER TABLE "content" ADD "accessType" "public"."content_accesstype_enum" NOT NULL DEFAULT 'premium'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "watch_history" ADD CONSTRAINT "FK_314147a1dae35e41c476eae1683" FOREIGN KEY ("episode_id") REFERENCES "episodes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "content" DROP COLUMN "accessType"`);
        await queryRunner.query(`DROP TYPE "public"."content_accesstype_enum"`);
    }
