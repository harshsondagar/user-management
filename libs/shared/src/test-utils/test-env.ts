export function testEnv() {
    ...
    return {
        ...
        postgresUser: process.env.TEST_POSTGRES_USER ?? 'test',
        postgresPassword: process.env.TEST_POSTGRES_PASSWORD ?? 'test',
        ...
        mongoUri: `mongodb://localhost:27018/test_mongo_${workerId}`,
    };
}
